...
<body>
    <nav class="N1">
        ...
        <ul>
            <li><a href="">Home</a></li>
            <li><a href="../../Cart/Dashboard/Seller" class="cart"><i class="fa-solid fa-cart-shopping"></i>Cart</a></li>
            ...
            <div class="form-popup" id="myForm">
              <form method="post" class="form-container" style="margin: .8em;">
                ...
                <a href="../../AddProduct/Dashboard/" style="color: black;border: 1px black solid;margin-top: 1em;box-shadow: 1px 2px 10px 1px;">Add Product</a>
              </form>
            </div>
        ...
        <?php
            ...
            while ($Message = mysqli_fetch_array($GetTextMessage))
            {
                ...
                echo " <section class='product'>
                        ...
                        <center><p>" . $Message['ProductDescription'] . "</p></center><br>
                        ...
                        if (isset($_POST[$Message['ProductKey']]))
                        {
                            ...
                            $destinationFilePath = "../../Cart/Dashboard/Seller/index.php";
