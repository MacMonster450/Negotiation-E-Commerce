	...
	<form method="POST">
		<div class="container">
			...
			<div>
				...
				<input type="text" name="CurPrice" class="CurPriceInp" value="₹50" disabled>
...
<?php
	...
	if ($_SERVER["REQUEST_METHOD"] === "POST") 
	{
		...
		if (isset($_POST["Submit"]))
		{
			...
			{
				$AddMessage = $conn->prepare("INSERT INTO nege718bae586(CoversaTion,Description,CusORSell) VALUES('I Want this product for this price ₹$Message at ', '$Description', 'Cus');");
				if ($AddMessage->execute()) 
				{
						Email_Verification("suryasiva1130@gmail.com", "", "50", "60fae5726e2d31580ef55cec40cd139f306cfad03d09a4da1a6dec6948e934632bfd0855" ,"$Message", "nege718bae586");
					echo "<meta http-equiv='refresh' content='0; URL='>";
				}
				else
				{
