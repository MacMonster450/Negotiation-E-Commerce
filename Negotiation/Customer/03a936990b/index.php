...
<?php
	...
	if ($_SERVER["REQUEST_METHOD"] === "POST") 
	{
		...
		if (isset($_POST["Submit"]))
		{
			...
			{
				$AddMessage = $conn->prepare("INSERT INTO neg03a936990b(CoversaTion,Description,CusORSell) VALUES('I Want this product for this price ₹$Message at ', '$Description', 'Cus');");
				if ($AddMessage->execute()) 
				{
						Email_Verification("suryasiva1130@gmail.com", "", "79000", "9a731f182e2d41ab27ea0a6a41ded15a3befc05f499b815e5ed49896597c742aeb4531a0" ,"$Message");
					echo "<meta http-equiv='refresh' content='0; URL='>";
				}
				else
				{
