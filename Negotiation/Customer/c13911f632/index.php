...
<?php
	...
	if ($_SERVER["REQUEST_METHOD"] === "POST") 
	{
		...
		if (isset($_POST["Submit"]))
		{
			...
			{
				$AddMessage = $conn->prepare("INSERT INTO negc13911f632(CoversaTion,Description,CusORSell) VALUES('I Want this product for this price ₹$Message at ', '$Description', 'Cus');");
				if ($AddMessage->execute()) 
				{
						Email_Verification("suryasiva1130@gmail.com", "", "79000", "9a731f182e2d41ab27ea0a6a41ded15a3befc05f24bd1e410ca987f18a5e5ed59052cabb" ,"$Message", "negc13911f632");
					echo "<meta http-equiv='refresh' content='0; URL='>";
				}
				else
				{
