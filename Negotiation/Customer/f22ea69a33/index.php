	...
	<form method="POST">
		<div class="container">
			...
			<div>
				...
				<input type="text" name="CurPrice" class="CurPriceInp" value="₹11" disabled>
...
<?php
	...
	if ($_SERVER["REQUEST_METHOD"] === "POST") 
	{
		...
		if (isset($_POST["Submit"]))
		{
			...
			{
				$AddMessage = $conn->prepare("INSERT INTO negf22ea69a33(CoversaTion,Description,CusORSell) VALUES('I Want this product for this price ₹$Message at ', '$Description', 'Cus');");
				if ($AddMessage->execute()) 
				{
						Email_Verification("suryasiva1130@gmail.com", "", "11", "60fae5726e2d31580ef55cec40cd139f306cfad0e7215c55c37956ee73c64a6074dd692f" ,"$Message", "negf22ea69a33");
					echo "<meta http-equiv='refresh' content='0; URL='>";
				}
				else
				{
