	...
	<form method="POST">
		<div class="container">
			...
			<div>
				...
				<input type="text" name="CurPrice" class="CurPriceInp" value="₹323" disabled>
...
<?php
	...
	if ($_SERVER["REQUEST_METHOD"] === "POST") 
	{
		...
		if (isset($_POST["Submit"]))
		{
			...
			{
				$AddMessage = $conn->prepare("INSERT INTO neg384dfbe457(CoversaTion,Description,CusORSell) VALUES('I Want this product for this price ₹$Message at ', '$Description', 'Cus');");
				if ($AddMessage->execute()) 
				{
						Email_Verification("suryasiva1130@gmail.com", "", "323", "60fae5726e2d31580ef55cec40cd139f306cfad017b6cae406bb4862da14d4de65d0edb2" ,"$Message", "neg384dfbe457");
					echo "<meta http-equiv='refresh' content='0; URL='>";
				}
				else
				{
