	...
	<form method="POST">
		<div class="container">
			...
			<div>
				...
				<input type="text" name="CurPrice" class="CurPriceInp" value="₹143330" disabled>
...
<?php
	...
	if ($_SERVER["REQUEST_METHOD"] === "POST") 
	{
		...
		if (isset($_POST["Submit"]))
		{
			...
			{
				$AddMessage = $conn->prepare("INSERT INTO negf1c4a94f4d(CoversaTion,Description,CusORSell) VALUES('I Want this product for this price ₹$Message at ', '$Description', 'Cus');");
				if ($AddMessage->execute()) 
				{
						Email_Verification("suryasiva1130@gmail.com", "", "143330", "9a731f182e2d41ab27ea0a6a41ded15a3befc05f8058407f647b5d7aba85048fdb603007" ,"$Message", "negf1c4a94f4d");
					echo "<meta http-equiv='refresh' content='0; URL='>";
				}
				else
				{
