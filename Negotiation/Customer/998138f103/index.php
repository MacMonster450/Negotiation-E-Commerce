	...
	<form method="POST">
		<div class="container">
			...
			<div>
				...
				<input type="text" name="ProductName" class="ProductNameInp" value="Gowttham S" disabled>
			</div>
			<div>
				<label class="CurPrice">Current Price :</label>
				<input type="text" name="CurPrice" class="CurPriceInp" value="₹2800" disabled>
...
<?php
	...
	if ($_SERVER["REQUEST_METHOD"] === "POST") 
	{
		...
		if (isset($_POST["Submit"]))
		{
			...
			{
				$AddMessage = $conn->prepare("INSERT INTO neg998138f103(CoversaTion,Description,CusORSell) VALUES('I Want this product for this price ₹$Message at ', '$Description', 'Cus');");
				if ($AddMessage->execute()) 
				{
						Email_Verification("suryasiva1130@gmail.com", "", "2800", "e23b432765bde469d756de7b200fc7cad1b7315e236b5c3b194575867396d809821c7f89" ,"$Message", "neg998138f103");
					echo "<meta http-equiv='refresh' content='0; URL='>";
				}
				else
				{
