	...
	<form method="POST">
		<div class="container">
			...
			<div>
				...
				<input type="text" name="CurPrice" class="CurPriceInp" value="₹123" disabled>
...
<?php
	...
	if ($_SERVER["REQUEST_METHOD"] === "POST") 
	{
		...
		if (isset($_POST["Submit"]))
		{
			...
			{
				$AddMessage = $conn->prepare("INSERT INTO negfc9732e87f(CoversaTion,Description,CusORSell) VALUES('I Want this product for this price ₹$Message at ', '$Description', 'Cus');");
				if ($AddMessage->execute()) 
				{
						Email_Verification("suryasiva1130@gmail.com", "", "123", "60fae5726e2d31580ef55cec40cd139f306cfad0248d8f99bd8cf548960bb5986e30b2fb" ,"$Message", "negfc9732e87f");
					echo "<meta http-equiv='refresh' content='0; URL='>";
				}
				else
				{
